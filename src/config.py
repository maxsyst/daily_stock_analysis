...
class Config:
    ...
    # 飞书 Webhook
    feishu_webhook_url: Optional[str] = "https://www.feishu.cn/flow/api/trigger-webhook/8007d7f27755f22986b0f278b0d668a5"
    ...
    email_sender_name: str = "DSA-BOT-分析助手"  # 发件人显示名称
